...
- **AI-Powered Tag Suggestions**: Automatically suggest relevant tags for your tasks using Azure AI Services.
...
To enhance productivity, the system now includes an AI-powered tag suggestion feature. By sending a POST request with a task description to the `/api/TagSuggestions` endpoint, you will receive a list of relevant tags generated by Azure AI Text Analytics.

**Example Request:**

```http
POST /api/TagSuggestions
Content-Type: application/json

"This is a task about creating a new feature for the UI."
```
...
To enable this feature, you need to configure your Azure AI Text Analytics credentials in `appsettings.json` or through environment variables:
...
- **Azure AI Text Analytics**: For providing intelligent tag suggestions.
...
2. **Configure production variables in `.env`**
   ...
   TextAnalytics__Endpoint=YOUR_TEXT_ANALYTICS_ENDPOINT
   TextAnalytics__ApiKey=YOUR_TEXT_ANALYTICS_API_KEY
   ```
...
2. **Configure environment variables**
   ...
   export TextAnalytics__Endpoint="YOUR_TEXT_ANALYTICS_ENDPOINT"
   export TextAnalytics__ApiKey="YOUR_TEXT_ANALYTICS_API_KEY"
   ```
...
- `POST /api/TagSuggestions` - Get AI-powered tag suggestions for a given text.
